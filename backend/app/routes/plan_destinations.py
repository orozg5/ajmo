...
async def create_destination_route(plan_id: str, body: DestinationCreate) -> DestinationResponse:
...
async def get_destinations_route(plan_id: str) -> list[DestinationResponse]:
...
async def delete_destination_route(plan_id: str, destination_id: str) -> Response:
